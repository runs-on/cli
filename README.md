...
```
curl -Lo ./roc https://github.com/runs-on/cli/releases/download/v3.0.3/roc_v3.0.3_darwin_arm64
chmod a+x ./roc
./roc --help
```
...
```
curl -Lo ./roc https://github.com/runs-on/cli/releases/download/v3.0.3/roc_v3.0.3_linux_amd64
chmod a+x ./roc
./roc --help
```
...
repos:
  - repo: https://github.com/runs-on/cli
    rev: v3.0.3  # Use the latest release tag
    hooks:
      - id: roc-lint
```
