...
```
curl -Lo ./roc https://github.com/runs-on/cli/releases/download/v3.0.4/roc_v3.0.4_darwin_arm64
chmod a+x ./roc
./roc --help
```
...
```
curl -Lo ./roc https://github.com/runs-on/cli/releases/download/v3.0.4/roc_v3.0.4_linux_amd64
chmod a+x ./roc
./roc --help
```
...
repos:
  - repo: https://github.com/runs-on/cli
    rev: v3.0.4  # Use the latest release tag
    hooks:
      - id: roc-lint
```
