...
```
curl -Lo ./roc https://github.com/runs-on/cli/releases/download/v2.12.4/roc_2.12.4_darwin_arm64
chmod a+x ./roc
./roc --help
```
...
```
curl -Lo ./roc https://github.com/runs-on/cli/releases/download/v2.12.4/roc_2.12.4_linux_amd64
chmod a+x ./roc
./roc --help
```
...
repos:
  - repo: https://github.com/runs-on/cli
    rev: v2.12.4  # Use the latest release tag
    hooks:
      - id: roc-lint
```
